...
public class MainFrame extends JFrame {
    ...
    int width  = (int) hboxRange.getMaximumSize().getWidth();
    int height = (int) hboxRange.getMinimumSize().getHeight() * 2;
    hboxRange.setPreferredSize(new Dimension(width, height));
    ...
    hboxButtons.add(Box.createHorizontalGlue());
    width  = (int) hboxRange.getMaximumSize().getWidth();
    height = (int) hboxRange.getMinimumSize().getHeight() * 2;
    hboxRange.setPreferredSize(new Dimension(width, height));
